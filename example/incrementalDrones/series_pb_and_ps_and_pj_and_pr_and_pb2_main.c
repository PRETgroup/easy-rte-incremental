#include "series_F_pb_and_ps_and_pj_and_pr_and_pb2.h"
#include <stdio.h>

#include "save_results.h"
#include <time.h>
#define RUN_REFERENCE "series_pb_and_ps_and_pj_and_pr_and_pb2"

void print_data(uint32_t count, inputs_pb_and_ps_and_pj_and_pr_and_pb2_t inputs, outputs_pb_and_ps_and_pj_and_pr_and_pb2_t outputs) {
...
int main() {
    ...
    for (uint16_t run = 0; run < RUNS; run++) {
        ...
        start = clock();
        enforcervars_pb_and_ps_and_pj_and_pr_and_pb2_t enf;
        inputs_pb_and_ps_and_pj_and_pr_and_pb2_t inputs;
        outputs_pb_and_ps_and_pj_and_pr_and_pb2_t outputs;
...
void pb_and_ps_and_pj_and_pr_and_pb2_run(inputs_pb_and_ps_and_pj_and_pr_and_pb2_t *inputs, outputs_pb_and_ps_and_pj_and_pr_and_pb2_t *outputs) {
    //do nothing
}
