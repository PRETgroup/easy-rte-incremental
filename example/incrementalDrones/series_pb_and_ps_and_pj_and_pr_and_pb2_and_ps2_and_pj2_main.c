#include "series_F_pb_and_ps_and_pj_and_pr_and_pb2_and_ps2_and_pj2.h"
#include <stdio.h>

#include "save_results.h"
#include <time.h>
#define RUN_REFERENCE "series_pb_and_ps_and_pj_and_pr_and_pb2_and_ps2_and_pj2"

void print_data(uint32_t count, inputs_pb_and_ps_and_pj_and_pr_and_pb2_and_ps2_and_pj2_t inputs, outputs_pb_and_ps_and_pj_and_pr_and_pb2_and_ps2_and_pj2_t outputs) {
...
int main() {
    ...
    for (uint16_t run = 0; run < RUNS; run++) {
        ...
        start = clock();
        enforcervars_pb_and_ps_and_pj_and_pr_and_pb2_and_ps2_and_pj2_t enf;
        inputs_pb_and_ps_and_pj_and_pr_and_pb2_and_ps2_and_pj2_t inputs;
        outputs_pb_and_ps_and_pj_and_pr_and_pb2_and_ps2_and_pj2_t outputs;
        
        pb_and_ps_and_pj_and_pr_and_pb2_and_ps2_and_pj2_init_all_vars(&enf, &inputs, &outputs);
        ...
        while(count++ < TICKS_PER_RUN) {
            ...
            pb_and_ps_and_pj_and_pr_and_pb2_and_ps2_and_pj2_run_via_enforcer(&enf, &inputs, &outputs);
...
void pb_and_ps_and_pj_and_pr_and_pb2_and_ps2_and_pj2_run(inputs_pb_and_ps_and_pj_and_pr_and_pb2_and_ps2_and_pj2_t *inputs, outputs_pb_and_ps_and_pj_and_pr_and_pb2_and_ps2_and_pj2_t *outputs) {
    //do nothing
}
