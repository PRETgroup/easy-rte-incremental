...
if __name__ == "__main__":  
	...
	os.chdir("example/water")
	basedir = "example" 

	composition_methods = ["monolithic", "parallel"]
	#policies = ["water1", "water2", "water3", "water4", "water5"]
	policies = ["water6", "water7", "water8", "water9", "water10"]
	...
	for c in composition_methods:
		for p in policies:
			...
			tcl_file = easyrte_directory + "example/water/" + direc + '/' + fname + ".tcl"
			print(tcl_file)
			...
			os.chdir(easyrte_directory+ basedir + "/" + "water")
