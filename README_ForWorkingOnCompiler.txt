...
./example_abc_series
    ...
    Manual Series ABC
gcc example/abc/manual_series_ab_and_ac_main.c example/abc/manual_series_F_ab_and_ac.c example/drones/save_results.c -o example_abc_manual_series
...
gcc -pg example/drones/series_px_and_py_main.c example/drones/series_F_px_and_py.c example/drones/save_results.c -o example_series_px_and_py
gcc -pg example/drones/series_px_and_py_and_pz_main.c example/drones/series_F_px_and_py_and_pz.c example/drones/save_results.c -o example_series_px_and_py_and_pz
gcc -pg example/drones/series_px_and_py_and_pz_and_pr_main.c example/drones/series_F_px_and_py_and_pz_and_pr.c example/drones/save_results.c -o example_series_px_and_py_and_pz_and_pr
gcc -pg example/drones/series_px_and_py_and_pz_and_pr_and_px2_main.c example/drones/series_F_px_and_py_and_pz_and_pr_and_px2.c example/drones/save_results.c -o example_series_px_and_py_and_pz_and_pr_and_px2
...
gcc example/drones/mono_px_and_py_main.c example/drones/F_px_and_py.c example/drones/save_results.c -o example_mono_px_and_py
gcc example/drones/mono_px_and_py_and_pz_main.c example/drones/F_px_and_py_and_pz.c example/drones/save_results.c -o example_mono_px_and_py_and_pz
gcc example/drones/mono_px_and_py_and_pz_and_pr_main.c example/drones/F_px_and_py_and_pz_and_pr.c example/drones/save_results.c -o example_mono_px_and_py_and_pz_and_pr
gcc example/drones/mono_px_and_py_and_pz_and_pr_and_px2_main.c example/drones/F_px_and_py_and_pz_and_pr_and_px2.c example/drones/save_results.c -o example_mono_px_and_py_and_pz_and_pr_and_px2
